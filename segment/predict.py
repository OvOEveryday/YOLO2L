...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train-seg2/GVLM_merge_result/weights/best.pt', help='model path(s)')
    # parser.add_argument('--source', type=str, default=ROOT / 'data/dataset_de/images/train/df022.png', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--source', type=str, default=ROOT / 'data/tifs/cut_baoxing', help='file/dir/URL/glob/screen/0(webcam)')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/predict-seg/test', help='save results to project/name')
