...
# GIT_INFO = check_git_info('https://github.com/OvOEveryday/YOLO2L.git')
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default= ROOT / 'weights/yolov5s-seg.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolo2l/yolo-s-emo-h6.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolo-s-emo-h6', help='save to project/name')
